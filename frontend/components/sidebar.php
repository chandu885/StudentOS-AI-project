...
elseif ($userRole == 3) {
    $menuItems = [
        ...
        ['label' => 'Print Attendance', 'icon' => 'fa-print', 'url' => '/faculty/attendance_print.php'],
...
elseif ($userRole == 2) {
    $menuItems = [
        ...
        ['label' => 'Assignments', 'icon' => 'fa-file-alt', 'url' => '/admin/assignments.php'],
        ['label' => 'Submissions', 'icon' => 'fa-upload', 'url' => '/admin/submissions.php'],
...
?>
<!-- Sidebar component styles loaded from assets/css/components/sidebar.css -->
