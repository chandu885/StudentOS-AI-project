...
?>
<?php
$pageTitle = 'Institution-Wide Coursework & Assignments - StudentOS AI';
...
?>
                <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 14px;">
                    <div>
                        <h1><i class="fas fa-file-signature" style="color: var(--primary); margin-right: 8px;"></i> Institution-Wide Coursework &amp; Assignments</h1>
                        <p class="page-subtitle">Assign tasks with instructions &amp; problem statement PDFs for specific semesters and departments, and monitor submission rates</p>
                    </div>
                ...
                <div class="card">
                    <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span style="font-size: 12px; color: var(--text-muted);">Administrator View</span>
                    </div>
                    <div class="card-body">
