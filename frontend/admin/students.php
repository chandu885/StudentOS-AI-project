...
?>
<?php
$pageTitle = 'Student Management - StudentOS AI';
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 14px; margin-bottom: 18px;">
                    <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                        ...
                        <?php foreach ($departmentsList as $deptItem): ?>
                            <a href="students.php?department=<?php echo urlencode($deptItem['code']); ?>&promotion_status=<?php echo urlencode($promFilter); ?>" class="btn <?php echo $deptFilter === $deptItem['code'] ? 'btn-primary' : 'btn-outline'; ?>" style="font-size: 12px; padding: 5px 12px;"><?php echo htmlspecialchars($deptItem['code']); ?></a>
                        <?php endforeach; ?>
                    </div>
