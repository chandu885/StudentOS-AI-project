...
class AuthMiddleware {
    ...
    public function authenticate() {
        ...
        // If no Bearer token in headers, check PHP session fallback (for browser AJAX / fetch)
        if (!$token) {
            ...
            if (empty($sessionToken) && !empty($_SESSION['session_token'])) {
                $sessionToken = $_SESSION['session_token'];
            }
            if (!$token && !empty($_SESSION['user']['id'])) {
